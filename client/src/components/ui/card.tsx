...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        "shadcn-card relative overflow-hidden rounded-2xl border bg-ds-elevated text-ds-primary shadow-ds-card transition-theme",
...
const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-lg font-extrabold leading-none tracking-[-0.03em] text-ds-primary", className)} {...props} />
  )
);
...
const CardDescription = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-sm font-medium text-ds-tertiary", className)} {...props} />
  )
);
